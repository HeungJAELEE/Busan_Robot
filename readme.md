...
### 14. Page 3 로봇 점검 Data수집 / Dry Run 기록

Page 3은 생산용 Page 1과 분리된 점검/데이터 수집 화면입니다. 목적은 실제 DI/DO 출력과 그리퍼 신호를 임시로 해제한 상태에서 Auto 프로그램을 반복 실행하고, 로봇별 실시간 패턴 데이터를 로컬 파일 또는 MySQL에 저장하는 것입니다.
